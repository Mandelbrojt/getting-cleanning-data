...
```
### Cross Tabs  
**Note**: for the following example, the first argument of the "xtabs" function will be the data displayed on the table, the second argument along with the "+" symbol specifies the variables that will be used to break down data.  
```{r, eval = FALSE}
data("UCBAdmissions")
